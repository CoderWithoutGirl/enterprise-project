        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            ...
                                                                            alt="notification" title="Upload New Idea"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;max-width: 300px;"
                                                                            width="300"
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 16px; line-height: 140%;">Your idea has just been commented by someone.</p>
                                                                <p style="font-size: 16px; line-height: 140%;">To
                                                                    view the new comments, please use the button
                                                                    below.</p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="left">
                                                                ...
                                                                <a href="${link}" target="_blank" class="v-size-width"
                                                                    style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #474343; background-color: #5cc740; border-radius: 3px;-webkit-border-radius: 3px; -moz-border-radius: 3px; width:100%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #ced4d9; border-top-style: solid; border-top-width: 3px; border-left-color: #ced4d9; border-left-style: solid; border-left-width: 3px; border-right-color: #ced4d9; border-right-style: solid; border-right-width: 3px; border-bottom-color: #ced4d9; border-bottom-style: solid; border-bottom-width: 3px;">
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://facebook.com/"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="../statics/images/image-2.png"
                                                                                            alt="Facebook"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://twitter.com/"
                                                                                        ...
                                                                                        <img src="../statics/images/image-1.png"
                                                                                            alt="Twitter"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://linkedin.com/"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="../statics/images/image-3.png"
                                                                                            alt="LinkedIn"
                    ...
                    <div class="u-row-container" style="padding: 0px 0px 11px;background-color: #ffffff">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 550px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px 0px 11px;background-color: #ffffff;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:550px;"><tr style="background-color: transparent;"><![endif]-->

                                <!--[if (mso)|(IE)]><td align="center" width="275" style="background-color: #ffffff;width: 275px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-family: 'Crimson Text', serif; font-size: 18px; line-height: 32.4px;">034-2288-600</span><br /><span
                                                                        style="font-family: 'Crimson Text', serif; font-size: 18px; line-height: 32.4px;">515
                                                                        Ngo Quyen, Ngu Hanh Son, Da
                                                                        Nang</span><br /><span
