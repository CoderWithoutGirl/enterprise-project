                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_3" style="font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:20px 30px 30px 40px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 22px; line-height: 30.8px;"><strong><span
                                                                                style="line-height: 30.8px; font-family: 'Crimson Text', serif; font-size: 22px;">Thanks.</span></strong></span><br />
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;">
                                                                    <span
                                                                        style="font-family: 'Crimson Text', serif; font-size: 18px; line-height: 32.4px;">501
                                                                        Ngo Quyen, Da Nang</span><br /><span
